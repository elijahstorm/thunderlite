...
const CYCLE_DELAY_MS = 30 * 60 * 1000 // 30 minutes between phases
const CODER_TIMEOUT_MS = 75 * 60 * 1000 // 75 min budget per coder run
const QA_TIMEOUT_MS = 30 * 60 * 1000 // 30 min budget per QA run
