...
type UnitData = ObjectAssetMeta & {
	...
	movementType:
		...
		| 'warship'
		| 'submarine'
		// Crosses land and water alike (hovercraft): cheap on land/shore, slow over
		// open ocean. See drag()/validTerrain in Pathing/movement.ts.
		| 'amphibious'
		// Climbs anything a foot unit can, but ignores terrain drag entirely — rough,
		// slippery and rugged tiles cost the same as open ground.
		| 'sure-footed'
	power: number
	health: number
	movement: number
...
export const unitData: UnitData[] = [
	...
	},
	{
		...
		actable: true,
		stealth: true,
		modifiers: ['End_Turn.Cloak', 'Damage.Stealth_Strike', 'Self_Action.Repairable'],
	},
	{
	...
	{
		url: '/game/play/unit/idle/outrider.png',
		frames: 4,
		xOffset: 0,
		yOffset: 0,
		attackSprite: {
			url: '/game/play/unit/attack/outrider.png',
			frames: 8,
			xOffset: 45,
			yOffset: 45,
		},
		name: 'Outrider',
		description:
			'Fast, far-seeing recon buggy. Cheap and fragile; reveals hidden enemies as it moves.',
		type: 'ground',
		weaponType: 'light',
		armorType: 'light',
		movementType: 'wheel',
		...
		range: COMMON_RANGE,
		actable: true,
		modifiers: ['Move.Tracking', 'Self_Action.Repairable'],
	},
	{
		url: '/game/play/unit/idle/strider.png',
		frames: 4,
		xOffset: 0,
		yOffset: 60,
		attackSprite: {
			url: '/game/play/unit/attack/strider.png',
			frames: 8,
			xOffset: 45,
			yOffset: 45,
		},
		name: 'Strider',
		description:
			'Towering legged sniper. Climbs any terrain and rains punishing fire down from high ground, but folds fast if caught in the open.',
		type: 'ground',
		weaponType: 'heavy',
		armorType: 'light',
		movementType: 'sure-footed',
		power: 45,
		health: 30,
		movement: 4,
		sight: 5,
	...
	{
		url: '/game/play/unit/idle/tidewalker.png',
		frames: 4,
		xOffset: 0,
		yOffset: 0,
		attackSprite: {
			url: '/game/play/unit/attack/tidewalker.png',
			frames: 8,
			xOffset: 45,
			yOffset: 45,
		},
		name: 'Tidewalker',
		description:
			'Amphibious hovercraft that skims across land and water alike. A flexible flanker that can even strike ships from the shallows.',
		type: 'ground',
		weaponType: 'medium',
		armorType: 'medium',
		...
		range: COMMON_RANGE,
		actable: true,
		modifiers: ['Can_Attack.Bombard', 'Self_Action.Repairable'],
	},
	{
		url: '/game/play/unit/idle/scorcher.png',
		frames: 4,
		xOffset: 0,
		yOffset: 0,
		attackSprite: {
			url: '/game/play/unit/attack/scorcher.png',
			frames: 8,
			xOffset: 45,
			yOffset: 45,
		},
		name: 'Scorcher',
		description:
			'Heavy flame tank. Its burning jet splashes across nearby foes and torches forest cover to ash.',
		type: 'ground',
		weaponType: 'heavy',
		armorType: 'heavy',
		movementType: 'tank',
		...
		range: COMMON_RANGE,
		actable: true,
		modifiers: ['Attack.Splash', 'Attack.Burn', 'Self_Action.Repairable'],
	},
	{
		url: '/game/play/unit/idle/shroud.png',
		frames: 4,
		xOffset: 0,
		yOffset: 60,
		attackSprite: null,
		name: 'Shroud',
		description:
			'Support vehicle that lays a rolling smoke screen, concealing friendly units as they advance.',
		type: 'ground',
		weaponType: 'light',
		armorType: 'light',
		movementType: 'wheel',
		...
		range: COMMON_RANGE,
		actable: true,
		modifiers: ['Move.Smoke', 'Self_Action.Repairable'],
	},
	{
		url: '/game/play/unit/idle/aegis.png',
		frames: 4,
		xOffset: 0,
		yOffset: 60,
		attackSprite: null,
		name: 'Aegis',
		description:
			'Heavy shield projector. Wraps adjacent allies in a protective field that blunts incoming damage.',
		type: 'ground',
		weaponType: 'light',
		armorType: 'heavy',
		movementType: 'tank',
		...
		range: COMMON_RANGE,
		actable: true,
		modifiers: ['Damage.Aegis', 'Self_Action.Repairable'],
	},
	{
		url: '/game/play/unit/idle/petrel-stormrider.png',
		frames: 4,
		xOffset: 0,
		yOffset: 60,
		attackSprite: {
			url: '/game/play/unit/attack/petrel-stormrider.png',
			frames: 8,
			xOffset: 45,
			yOffset: 45,
		},
		name: 'Petrel Stormrider',
		description:
			'Storm-hardened interceptor. Rides storm cells unharmed and unslowed, striking other aircraft from inside the weather.',
		type: 'air',
		weaponType: 'light',
		armorType: 'light',
		movementType: 'low air',
		...
		range: COMMON_RANGE,
		actable: true,
		modifiers: ['Can_Attack.Air_Raid', 'Storm_Rider', 'Self_Action.Repairable'],
	},
	{
		...
		name: 'Albatross Gunship',
		description:
			'Lumbering ground-attack gunship. Its rocket barrage washes over every tile beside the target.',
		type: 'air',
		weaponType: 'heavy',
		armorType: 'medium',
		movementType: 'low air',
		...
		range: COMMON_RANGE,
		actable: true,
		modifiers: ['Attack.Splash', 'Can_Attack.Bombard', 'Self_Action.Repairable'],
	},
	{
		url: '/game/play/unit/idle/kestrel-sentry.png',
		frames: 4,
		xOffset: 0,
		yOffset: 60,
		attackSprite: null,
		name: 'Kestrel Sentry',
		description:
			'Feather-light recon drone. Its radar sweep drags anything hiding in cloud, storm or cloak out into the open.',
		type: 'air',
		weaponType: 'light',
		armorType: 'light',
		movementType: 'low air',
		...
		range: [1, 3],
		actable: true,
		modifiers: ['Move.Radar', 'Move.Tracking', 'Self_Action.Repairable'],
	},
	{
		url: '/game/play/unit/idle/shrike-interdictor.png',
		frames: 4,
		xOffset: 0,
		yOffset: 60,
		attackSprite: {
			url: '/game/play/unit/attack/shrike-interdictor.png',
			frames: 8,
			xOffset: 45,
			yOffset: 45,
		},
		name: 'Shrike Interdictor',
		description:
			'Standoff missile platform. Lobs guided missiles at aircraft and ground from well beyond the front, but cannot fire and reposition in the same turn.',
		type: 'air',
		weaponType: 'medium',
		armorType: 'light',
		movementType: 'low air',
	...
	// maps and campaign levels, so a new unit must never be inserted mid-array
	// (it would shift every later type and corrupt existing maps).
	{
		url: '/game/play/unit/idle/breaker.png',
		frames: 4,
		xOffset: 0,
		yOffset: 60,
		attackSprite: {
			url: '/game/play/unit/attack/breaker.png',
			frames: 8,
			xOffset: 45,
			yOffset: 45,
		},
		name: 'Breaker',
		description:
			'Siege gun that arcs shells straight through cover, so dug-in defenders get no shelter. The blast washes over every tile beside the impact.',
		type: 'ground',
		weaponType: 'heavy',
		armorType: 'light',
		movementType: 'tank',
