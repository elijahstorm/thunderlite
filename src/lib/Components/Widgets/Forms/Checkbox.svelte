...
<fieldset>
	...
	<div class="flex items-center mb-4">
		...
		<label for="checkbox-1" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"
			>I agree to the <button type="button" class="text-blue-600 hover:underline dark:text-blue-500"
	...
	<div class="flex mb-4">
		...
		<div class="ml-2 text-sm">
			...
			>
			<p id="helper-checkbox-text" class="text-xs font-normal text-gray-500 dark:text-gray-400">
