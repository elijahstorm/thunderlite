...
<form on:submit={changeSearch(searchInput.value)}>
	<div class="relative flex">
		<label for="maps-search" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">
			Search for Maps
		</label>
		<button
		...
		{#if showTypes}
			<div
				class="absolute top-10 mt-1 z-20 bg-white divide-y divide-gray-100 rounded-lg shadow-lg w-44 shadow-gray-400 dark:bg-gray-700"
