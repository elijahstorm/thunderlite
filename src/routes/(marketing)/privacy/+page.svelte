	...
	<div data-custom-class="body">
				...
				<strong>
					<span style="font-size: 15px;">
						<span data-custom-class="subtitle"
							>Last updated <bdt class="question">February 09, 2023</bdt>
						</span>
					</span>
				</strong>
			</span>
				...
				<span style="color: rgb(89, 89, 89); font-size: 15px;">
					<span data-custom-class="body_text"
						>This privacy notice for <bdt class="question"
							>Haja<bdt class="block-component" />
						</bdt>
					...
					<span data-custom-class="body_text"
						...
						/>"<strong>process</strong>"<bdt class="statement-end-if-in-editor" />) your
						information when you use our services (<bdt
							class="block-component"
				...
				<span style="font-size: 15px; color: rgb(89, 89, 89);">
					<span style="font-size: 15px; color: rgb(89, 89, 89);">
						<span data-custom-class="body_text"
							...
							<bdt class="question">
								<a
									href="https://haja-web.vercel.app/"
									target="_blank"
									rel="noreferrer"
									data-custom-class="link">https://haja-web.vercel.app/</a
								>
							</bdt>
							<span style="font-size: 15px;">
								<span style="color: rgb(89, 89, 89);">
				...
				<span style="font-size: 15px; color: rgb(89, 89, 89);">
					<span style="font-size: 15px; color: rgb(89, 89, 89);">
						<span data-custom-class="body_text"
							...
							/>
							(<bdt class="question"
								>Haja)<span style="font-size: 15px; color: rgb(89, 89, 89);">
									<span style="font-size: 15px; color: rgb(89, 89, 89);">
										<span data-custom-class="body_text">
											<span style="font-size: 15px;">
												<span style="color: rgb(89, 89, 89);">
			...
			<span style="font-size: 15px;">
				<span style="color: rgb(127, 127, 127);">
					<span data-custom-class="body_text">
						...
						<bdt class="question">elijahstormai@gmail.com</bdt>.</span
					>
				</span>
			</span>
		</div>
		...
		<div style="line-height: 1.5;">
			<span style="font-size: 15px;">
				<span data-custom-class="body_text">
					...
					you interact with <bdt class="block-component" />
					<bdt class="question">Haja</bdt>
					<bdt class="statement-end-if-in-editor" /> and the Services, the choices you make,
		...
		<div style="line-height: 1.5;">
			<span style="font-size: 15px;">
				<span data-custom-class="body_text">
					...
					<bdt class="block-component" />We do not receive any information from third
					parties.<bdt class="else-block" />
				</span>
			</span>
		</div>
		<div style="line-height: 1.5;">
		...
		<div style="line-height: 1.5;">
			<span style="font-size: 15px;">
				<span data-custom-class="body_text">
					<strong
						>In what situations and with which <bdt class="block-component" />parties do
						we share personal information?</strong
					>
		...
		<div style="line-height: 1.5;">
			<span style="font-size: 15px;">
				<span data-custom-class="body_text">
					...
					<bdt class="block-component" />organizational<bdt
						class="statement-end-if-in-editor"
					/>
					...
					<bdt class="block-component" />unauthorized<bdt
						class="statement-end-if-in-editor"
		...
		<div style="line-height: 1.5;">
			<span style="font-size: 15px;">
				<span data-custom-class="body_text">
					...
					<bdt class="question">
						<a
							href="https://haja-web.vercel.app/data-request"
							target="_blank"
							rel="noreferrer"
							data-custom-class="link">https://haja-web.vercel.app/data-request</a
						>
					</bdt>
					<bdt class="else-block" />, or by contacting us. We will consider and act upon
		...
		<div style="line-height: 1.5;">
			<span style="font-size: 15px;">
				<span data-custom-class="body_text"
					...
					<bdt class="question">Haja</bdt>
					<bdt class="statement-end-if-in-editor" /> does with any information we collect?
					Click
				</span>
			</span>
			<a data-custom-class="link" href="#toc">
		...
		<div style="line-height: 1.5;">
			<a data-custom-class="link" href="#request">
				<span style="color: rgb(89, 89, 89);"
					>14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</span
				>
			</a>
		</div>
		<div style="line-height: 1.5;">
			...
			<span style="font-size: 15px; color: rgb(89, 89, 89);">
				<span style="font-size: 15px; color: rgb(89, 89, 89);">
					<span data-custom-class="body_text">
						...
						use. The personal information we collect may include the following:<span
							style="font-size: 15px;"
						>
							<span data-custom-class="body_text">
		...
		<div id="sensitiveinfo" style="line-height: 1.5;">
			<span style="font-size: 15px;">
				<span data-custom-class="body_text">
					<strong>Sensitive Information.</strong> <bdt class="block-component" />We do not
			...
			<span style="font-size: 15px; color: rgb(89, 89, 89);">
				<span style="font-size: 15px; color: rgb(89, 89, 89);">
					<span data-custom-class="body_text">
						...
						section called <bdt class="block-component" />"<bdt
							class="statement-end-if-in-editor"
						/>
						<span style="font-size: 15px;">
							<span data-custom-class="body_text">
		...
		<div style="line-height: 1.5;">
			<span data-custom-class="body_text">
				<span style="font-size: 15px;">
					...
					permission:<bdt class="block-component" />
				</span>
			</span>
			<div style="line-height: 1.5;">
				<bdt class="block-component">
						...
						<li style="line-height: 1.5;">
							<span style="font-size: 15px;">
								<span data-custom-class="body_text">
									...
									settings.<bdt class="statement-end-if-in-editor" />
								</span>
							</span>
						</li>
					</ul>
							...
							<span style="font-size: 15px; color: rgb(89, 89, 89);">
								<span style="font-size: 15px; color: rgb(89, 89, 89);">
									<span data-custom-class="body_text">
										...
										</strong>We may process your information so you can create
										...
										<span style="font-size: 15px; color: rgb(89, 89, 89);">
											<span data-custom-class="body_text">
												<strong
													...
													users.
												</strong>We may process your information to respond
												to your inquiries and solve any potential issues you
												might have with the requested service.<span
													style="font-size: 15px; color: rgb(89, 89, 89);"
												>
													<span
														style="font-size: 15px; color: rgb(89, 89, 89);"
															...
															<span style="color: rgb(89, 89, 89);">
																...
																>
																	...
																	>
																		<strong
																			>To request feedback.
																		</strong>We may process your
																		information when necessary
																		to request feedback and to
																		contact you about your use
																																	...
																																	<span
																																		...
																																		>
																																			<a
																																				...
																																				rel="noreferrer"
																																				data-custom-class="link"
																																				>https://haja-web.vercel.app/data-request</a
																																			>
																																		</bdt>
																																		<bdt
																																			class="else-block"
