...
<svelte:head>
	<title>Match History | ThunderLite</title>
</svelte:head>

<section>
	<header class="mb-6">
		<p class="section-eyebrow">Battle log</p>
		<h1 class="mt-1 text-2xl font-semibold tracking-tight text-foreground">Match history</h1>
		<p class="mt-1 text-sm text-muted-foreground">
			Every game you have finished. Games still in progress are under
			<a href="/games" class="text-foreground underline underline-offset-2">your games</a>.
		</p>
	</header>
	...
	{#if entries.length === 0}
		<div class="card p-8 text-center">
			...
			<p class="mt-3 font-medium text-foreground">No finished matches yet</p>
			<a class="btn btn-primary mt-4" href="/make">Start a game</a>
		</div>
	{:else}
