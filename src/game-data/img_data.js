...
Animations.Declare(
	Images.Declare('Sheets/animations/ExplosionSheet.png', 'Expl Sheet'),
	'Explosion',
	4,
	false
).Frame_Size(4, 3)
Animations.Declare(
	Images.Declare('Sheets/animations/PointerAnimation.png', 'pointerAni'),
	'Pointer Animation',
	20,
	true
).Frame_Size(4, 1)

Animations.Declare(Images.Declare('Weather/Rain/Sheet.png', 'Rain'), 'Rain', 6, true).Frame_Size(
	4,
	1
)
Animations.Declare(
	Images.Declare('Weather/Rain/Particles.png', 'Droplets'),
	'Rain Particles',
	4,
	false
)
...
Animations.Declare(Images.Declare('Weather/Snow/Sheet.png', 'Snow'), 'Snow', 14, true).Frame_Size(
	4,
	3
)
Animations.Declare(
	Images.Declare('Weather/Snow/Particles.png', 'Snow Droplets'),
	'Snow Particles',
	14,
	false
)
...
Animations.Declare(
	Images.Declare('Weather/Heat Wave/Sheet.png', 'Heat Wave'),
	'Heat Wave',
	48,
	true
).Frame_Size(4, 3)
Animations.Declare(
	Images.Declare('Weather/Heat Wave/Particles.png', 'Heat Wave Particles'),
	'Heat Wave Particles',
	12,
	false
)
